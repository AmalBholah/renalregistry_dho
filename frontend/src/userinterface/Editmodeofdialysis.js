...
import {createmodeofdialysis, updatemodeofdialysis} from "../apis/dialysis-api";
import { Navigate } from "react-router-dom";
import ArrowBackIcon from "@mui/icons-material/ArrowBack";
import { blue } from "@mui/material/colors";
import PersonIcon from "@mui/icons-material/Person";
import ArrowCircleDownIcon from "@mui/icons-material/ArrowCircleDown";
export default class Editmodeofdialysis extends Component {
  state = {
    activeStep: 0,
  ...
  async componentDidMount() {
    ...
    let restoredState = utils.getTempMemoryModeofdialysis();
  ...
  async handleNext() {
    ...
    if (this.state.activeStep == 1) {
      ...
      await updatemodeofdialysis(objectToSend);
